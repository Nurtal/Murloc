...
def run():
    ...
    input_file = "/home/bran/Workspace/PRECISINV/ccp/dataset/rnaseq_RA.csv"
    output_root = "/home/bran/Workspace/PRECISINV/ccp/iterative_mining"
    output_folder = "/home/bran/Workspace/PRECISINV/ccp/iterative_mining/murloc_iteration_0"
    action_file = "/home/bran/Workspace/Murloc/ccp_config.txt"

    ## init log file
    log_file = open(output_root+"/acc_log.csv", "w")
    log_file.write("ITERATION,LDA,RF\n")
    ...
    while(acc_checked):
        ...
        log_file.write(str(iteration_cmpt)+","+str(lda_acc)+","+str(rf_acc)+"\n")
